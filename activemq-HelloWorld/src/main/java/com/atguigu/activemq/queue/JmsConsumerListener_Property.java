...
public class JmsConsumerListener_Property {
    ...
    public static void main(String[] args) throws JMSException, IOException {
        ...
        messageConsumer.setMessageListener((message) -> {
            if(null != message && message instanceof  TextMessage){
                ...
                try {
                    System.out.println("***消费者-消息监听-收到消息***： " + textMessage.getText());
                    System.out.println("***消费者-消息监听-收到消息属性vip_lv***： " + textMessage.getStringProperty("vip_lv"));
                    System.out.println("***消费者-消息监听-收到消息属性***： " + textMessage.getBooleanProperty("is vip 3"));
                } catch (JMSException e) {
                    e.printStackTrace();
                }
            }
